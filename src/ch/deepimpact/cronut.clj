...
(def data-readers
  {'cronut/trigger  ch.deepimpact.cronut/trigger-builder
   'cronut/cron     ch.deepimpact.cronut/shortcut-cron
   'cronut/interval ch.deepimpact.cronut/shortcut-interval})
